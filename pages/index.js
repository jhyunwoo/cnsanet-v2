...
export default function Home() {
  ...
  return (
    <div className="bg-slate-100">
      ...
      <div
        className={`min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ${login} m-4 rounded-xl backdrop-blur-xl absolute top-0 bottom-0 right-0 left-0`}
      >
